...
@Slf4j
public class NoDuplicationAvailabilityPeriodValidator implements ConstraintValidator<NoDuplicateAvailabilityPeriod, List<UpdateProfessionalAvailabilityDto.AvailabilityPeriod>> {
  ...
  public boolean isValid(List<UpdateProfessionalAvailabilityDto.AvailabilityPeriod> availabilityPeriods, ConstraintValidatorContext constraintValidatorContext) {
    Set<UpdateProfessionalAvailabilityDto.AvailabilityPeriod> uniqueAvailabilitySet = new HashSet<>(availabilityPeriods);
