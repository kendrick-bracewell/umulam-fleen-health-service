...
public class GoogleCalendarAdapter {
  ...
  private static InputStream getCredentialInputStream() throws IOException {
    InputStream in = GoogleCalendarAdapter.class.getResourceAsStream(GoogleCalendarAdapter.SERVICE_CREDENTIALS_FILE_PATH);
    if (in == null) {
      throw new FileNotFoundException("Resource not found: ".concat(GoogleCalendarAdapter.SERVICE_CREDENTIALS_FILE_PATH));
    }
    return in;
  }
